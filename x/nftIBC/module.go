...
func (am AppModule) OnRecvPacket(
	...
	ctx.EventManager().EmitEvent(
		sdk.NewEvent(
			...
			sdk.NewAttribute(AttributeKeyReceiver, sdk.AccAddress(data.Receiver).String()),
...
func (am AppModule) OnTimeoutPacket(
	...
	ctx.EventManager().EmitEvent(
		sdk.NewEvent(
			EventTypeTimeout,
			sdk.NewAttribute(AttributeKeyRefundReceiver, sdk.AccAddress(data.Owner).String()),
