...
func RegisterCodec(cdc *codec.Codec) {
	cdc.RegisterConcrete(MsgTransferNFT{}, "marketplace/transfer/MsgTransfer", nil)
	cdc.RegisterConcrete(NFTPacketData{}, "marketplace/transfer/PacketDataTransfer", nil)
}
