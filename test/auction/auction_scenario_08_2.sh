...
sleep_time=5
echo "run test 08.2:"
echo "Create an NFT. Put this NFT on auction. user2 makes a bid equal opening price. dgaming makes a lesser bid."
...
mpcli tx marketplace bid $nft_id $buyer_id 195token -c 0.02  --from dgaming -y <<< '12345678' >/dev/null
