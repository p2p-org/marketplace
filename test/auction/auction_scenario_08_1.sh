...
sleep_time=5
echo "run test 08.1:"
echo "Create an NFT. Put this NFT on auction. user2 makes a bid equal opening price. dgaming makes an equal bid."
echo "Expected: auction_lot's field lastBid updated with user2 information."
...
mpcli tx marketplace bid $nft_id $buyer_id 200token -c 0.02  --from dgaming -y <<< '12345678' >/dev/null
