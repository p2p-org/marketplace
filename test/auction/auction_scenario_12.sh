...
echo "run test 12:"
echo "Create an NFT. Put this NFT on auction. user2 makes a bid. Remove NFT from auction."
...
if [[ $status == "default" ]] && [[ $owner == $user1_id ]] && [[ -z $auc_id ]]
then
      echo "remove_from_auction was performed by user1"
else
      echo "test FAILURE"
      exit 1
fi
