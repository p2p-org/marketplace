...
echo "run test 12:"
echo "Create an NFT and put it on market. Remove it from market."
echo "Expected: NFT Status field equals default."
uu=$(uuidgen)
...
mpcli tx marketplace remove_from_market $nft_id --from user1 -y <<< '12345678' >/dev/null
